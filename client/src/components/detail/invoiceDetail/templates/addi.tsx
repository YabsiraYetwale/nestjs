...
function CustomFieldsForm({ params }: any) {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <br />
      <button type="submit" className=" bg-transparent hover:bg-transparent flex text-purple-600 font-semibold items-center space-x-2 px-3 py-2 rounded-sm border border-purple-600">
        Create
      </button>
    </form>
  );
